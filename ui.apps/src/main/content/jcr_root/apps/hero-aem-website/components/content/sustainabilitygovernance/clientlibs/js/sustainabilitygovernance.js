$(document).ready(function () {
  ...
  const slickSettings = {
    ...
    arrows: true,
    prevArrow:
      "<img class='a-left control-c next slick-prev' src='/content/dam/hero-aem-website/brand/design/icons/href-right-icon.svg'>",
    nextArrow:
      "<img class='a-right control-c next slick-next' src='/content/dam/hero-aem-website/brand/design/icons/href-right-icon.svg'>",
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [
  ...
  $(".left--sub-menu.slick-initialized").on("afterChange", function () {
    let centerSlide = $(".left--sub-menu.slick-initialized").find(
      ".slick-center"
    );
