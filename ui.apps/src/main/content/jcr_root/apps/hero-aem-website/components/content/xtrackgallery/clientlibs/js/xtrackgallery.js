$(document).ready(function () { 
    ...
    if($('.xpulse-exp-book-now-wrap').length > 0){
      ...
      document.addEventListener("scroll", function () {
          ...
          console.log(isInViewport(footerVisible),"isInViewport(footerVisible)");
          isInViewport(footerVisible) ? $(".xpulse-exp-book-now-wrap").addClass("d-none") : $(".xpulse-exp-book-now-wrap").removeClass("d-none")
      }, {
          passive: true
      });
    }
