...
if (null == locationData) {
  if ("geolocation" in navigator) {
    ...
    let defaultservlet = document.getElementById('defaultservlet')
    if(document.getElementById('defaultservlet')) {
      defaultservlet=document.getElementById('defaultservlet').value;
    };
