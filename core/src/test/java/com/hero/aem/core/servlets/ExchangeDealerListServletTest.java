...
class ExchangeDealerListServletTest {

    @InjectMocks
    ExchangeDealerListServlet exchangeDealerListServlet;
    @Mock
    ...
    void doPostTest(AemContext aemContext) throws ServletException,IOException {
        ...
        exchangeDealerListServlet.activate();
        exchangeDealerListServlet.doPost(req,res);
    }
}