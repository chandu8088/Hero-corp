...
class ExchangeStateListServletTest {
    @InjectMocks
    ExchangeStateListServlet exchangeStateListServlet;
    @Mock
    ...
    void doPostTest(AemContext aemContext) throws ServletException, IOException {
        ...
        exchangeStateListServlet.activate();
        exchangeStateListServlet.doPost(req,res);
    }
}