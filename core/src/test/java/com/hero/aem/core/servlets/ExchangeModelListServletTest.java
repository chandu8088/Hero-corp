...
class ExchangeModelListServletTest {

    @InjectMocks
    ExchangeModelListServlet exchangeModelListServlet;
    @Mock
    ...
    void doPostTest(AemContext aemContext) throws ServletException, IOException {
        ...
        exchangeModelListServlet.activate();
        exchangeModelListServlet.doPost(req,res);
    }
}