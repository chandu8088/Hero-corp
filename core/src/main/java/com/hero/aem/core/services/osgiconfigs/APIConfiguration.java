...
public @interface APIConfiguration {
    ...
    @AttributeDefinition(name = "Exchange Journey APP Name", description = "Exchange Journey api App Name", type = AttributeType.STRING)
    String exchangeJourneyAppName();

    @AttributeDefinition(name = "Exchange Journey APP Token", description = "Exchange Journey api App Token", type = AttributeType.STRING)
    String exchangeJourneyAppToken();

    @AttributeDefinition(name = "Price Promise Authorization Header", description = "Price Promise Authorization Header", type = AttributeType.STRING)
    String pricepromiseauthheader();

    @AttributeDefinition(name = "Exchange Enquiry User Name", description = "Exchange Enquiry Creation User Name", type = AttributeType.STRING)
    String exchangeenquiryusername() default "WSUSER";

    @AttributeDefinition(name = "Exchange Enquiry Password", description = "Exchange Enquiry Creation Password", type = AttributeType.STRING)
    String exchangeenquirypassword() default "WSUSER_1";

    @AttributeDefinition(name = "Price Promise ORG ID", description = "Price Promise ORG ID", type = AttributeType.STRING)
    String pricepromiseorgid();

    @AttributeDefinition(name = "Price Promise APP ID", description = "Price Promise APP ID", type = AttributeType.STRING)
    String pricepromiseappid();
}
